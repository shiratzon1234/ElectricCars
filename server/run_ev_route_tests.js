...
import { GEToriginAnddest } from './your-algorithm-file.js'; // Replace with your actual file

const testFilePath = './ev_route_algorithm_edge_tests.json'; // Place the JSON in the same folder
